$(document).ready(function () {
  ...
  $('#contact-form').submit(function (event) {
    ...
    // Create combined message for fallback compatibility
...
${message}
    ...
    // Create template parameters object with both individual fields and combined message
    ...
    emailjs.send('service_d3uzcv9', 'template_5mnn9vb', templateParams).then(
      function (response) {
